...
PORTABLE_CORE_SOURCES = \
	src/core/correlation.c src/core/enumeration.c src/core/input_switch.c src/core/mccs_capabilities.c src/core/monitor_knowledge.c src/core/picture_mode.c src/core/profile_store.c src/core/provider.c src/core/rss_ddc.c src/core/verify.c \
...
TESTS = \
	...
	$(BUILD)/test_dcpdpservice $(BUILD)/test_dcpdpservice_get $(BUILD)/test_dcpdpservice_set $(BUILD)/test_monitor_knowledge \
