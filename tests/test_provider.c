...
int main(void) {
    ...
    assert(rss_ddc_provider_capabilities(RSS_DDC_PROVIDER_PS190) == RSS_DDC_CAP_GET_VCP);
    assert(rss_ddc_provider_capabilities(RSS_DDC_PROVIDER_DCPDP13) == RSS_DDC_CAP_NONE);
