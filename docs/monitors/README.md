...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Samsung | Odyssey G75F | Built-in HDMI / `AppleDCPPS190`; USB-C → DisplayPort / `DCPDP13Service` | Hardware validated | Hardware validated on HDMI/PS190; see path details | Hardware validated on HDMI/PS190 only | GET framing differs by provider path | `25F84` | [Odyssey G75F](samsung-odyssey-g75f.md) |
