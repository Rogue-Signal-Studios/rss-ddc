...
| BenQ | XL2730Z | DisplayPort / `DCPDPService` / `DCPEXT2` | Hardware validated | Unverified | Unverified | GET/DPCD runtime supported; SET validation-only (`validate-dcpdpservice-set`); EDID unsupported | `25F84` | [XL2730Z](benq-xl2730z.md) |
